 ...
 *
 * Todo settings are loaded from:
 * - <agentDir>/todos.settings.json
 * - <repo-root>/.agents/todos.settings.json
 * - <repo-root>/.agents/todos.settings.local.json
 * Defaults:
 * {
...
const TODO_SETTINGS_NAME = 'todos'
...
function mergeTodoSettings(
  base: Partial<TodoSettings>,
  override: Partial<TodoSettings>,
): Partial<TodoSettings> {
  return {
    gc: override.gc ?? base.gc,
    gcDays: override.gcDays ?? base.gcDays,
  }
}
